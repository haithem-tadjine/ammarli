...
export class InitDatabase1787403666027 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            CREATE TABLE "wilayas" (
                ...
                "is_debt_ceiling_enabled" boolean NOT NULL DEFAULT true,
                "exempted_communes" jsonb DEFAULT '[]',
                ...
                CONSTRAINT "UQ_32052c4ea95aa7ae74b41a761f6" UNIQUE ("code"),
                CONSTRAINT "PK_wilaya_id" PRIMARY KEY ("id")
            )
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            CREATE TABLE "users" (
                ...
                "managedWilaya" character varying,
                "managedCommune" character varying,
        ...
        `);
        await queryRunner.query(`
            CREATE UNIQUE INDEX "UQ_user_phone_role" ON "users" ("phone")
        ...
        await queryRunner.query(`
            CREATE TABLE "system_settings" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
                "bottledCommission" numeric(10, 2) NOT NULL DEFAULT '3',
                "bottledCustomerMarkup" numeric(10, 2) NOT NULL DEFAULT '3',
                "tankerSpringCommission" numeric(10, 2) NOT NULL DEFAULT '0.3',
                "tankerSpringCustomerMarkup" numeric(10, 2) NOT NULL DEFAULT '5',
                "tankerWellCommission" numeric(10, 2) NOT NULL DEFAULT '50',
                "tankerWellCustomerMarkup" numeric(10, 2) NOT NULL DEFAULT '50',
                "tankerWellVolumeUnit" integer NOT NULL DEFAULT '1500',
                "maxDebtAllowed" numeric(10, 2) NOT NULL DEFAULT '2000',
                "enableAutoSuspend" boolean NOT NULL DEFAULT true,
        ...
        await queryRunner.query(`
            CREATE TABLE "drivers" (
                "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
                "type" "public"."drivers_type_enum" NOT NULL DEFAULT 'BOTTLED',
                "rating" double precision NOT NULL DEFAULT '5',
                "totalJobs" integer NOT NULL DEFAULT '0',
                "truckPlate" character varying,
                "capacity" integer,
                "waterType" character varying,
                "walletBalance" numeric(10, 2) NOT NULL DEFAULT '0',
                "totalEarnings" numeric(10, 2) NOT NULL DEFAULT '0',
                "app_commission_debt" numeric(10, 2) NOT NULL DEFAULT '0',
        ...
        await queryRunner.query(`
            CREATE TABLE "requests" (
                ...
                "status" "public"."requests_status_enum" NOT NULL DEFAULT 'SEARCHING',
        ...
        await queryRunner.query(`
            CREATE TABLE "ratings" (
                ...
                "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
                "updated_by" character varying NOT NULL DEFAULT 'system',
                CONSTRAINT "REL_6031885aa022434a6fda1d8204" UNIQUE ("requestId"),
        ...
        await queryRunner.query(`
            CREATE TABLE "pricing_rules" (
                ...
                "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
                "updated_by" character varying NOT NULL DEFAULT 'system',
                CONSTRAINT "PK_pricing_rule_id" PRIMARY KEY ("id")
            )
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_be846ad4b43f40acc7034ef7f40" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "requests"
            ADD CONSTRAINT "FK_f80169fce8fd99bca1d26e3a8ed" FOREIGN KEY ("driverId") REFERENCES "drivers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "ratings"
            ADD CONSTRAINT "FK_b7240150ac0e06ea1f1b6825130" FOREIGN KEY ("reviewerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "ratings"
            ADD CONSTRAINT "FK_64d6d3099b73aee4307b0044b8d" FOREIGN KEY ("targetId") REFERENCES "drivers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "ratings"
            ADD CONSTRAINT "FK_6031885aa022434a6fda1d8204e" FOREIGN KEY ("requestId") REFERENCES "requests"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "pricing_rules"
            ADD CONSTRAINT "FK_ffc0c09880090e2d0b3e2bf897c" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "pricing_rules"
            ADD CONSTRAINT "FK_89d8741b995e12f9f8f1edf1867" FOREIGN KEY ("wilayaId") REFERENCES "wilayas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "Clients"
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."UQ_product_wilaya_pricing"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            DROP INDEX "public"."UQ_user_phone_role"
        `);
        await queryRunner.query(`
            DROP TABLE "users"
        `);
